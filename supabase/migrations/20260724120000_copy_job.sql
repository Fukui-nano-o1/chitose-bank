...
-- 内容列（作物・作業・場所・報酬・写真・危険箇所・日程等）はそのままコピー。日程は下書きso編集フローで調整する。
...
begin
  ...
  insert into public.jobs (
    ...
    v_uid, 'draft',
    v_src.crop, v_src.task, v_src.zip, v_src.prefecture, v_src.city, v_src.address, v_src.town, v_src.date_label, v_src.date_start, v_src.date_end, v_src.draft_step,
