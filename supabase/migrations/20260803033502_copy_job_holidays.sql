-- copy_job に holidays を追加（2026-08-03・jobs_holidaysの続き）：
-- コピー時に休日を引き継ぐ。日程が過ぎて日程を空にする場合は休日も空にする（日程と休日は常にワンセット）
-- ※本migrationはMCP直接適用済み（version 20260803033502）。2026-07-21ルールに従いrepoへ写経
