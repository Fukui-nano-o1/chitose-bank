export const TERMS_ARTICLES = [
  { id:"terms-1",  title:"第1条 サービスの位置づけ", body:[
    "当社は、求人者と求職者が利用する求人情報および求職情報の掲載の場 chitose-bank を提供する。",
    "当社は、求人情報および求職情報を掲載する場の提供者として本サービスを運営する。",
    "雇用条件の交渉、契約の締結および雇用の開始は、求人者と求職者が、自らの判断と責任において直接行います。本サービスは、そのための連絡と記録の手段を提供するにとどまり、運営者は交渉と契約に関与しません。",
  ...
  { id:"terms-7",  title:"第7条 掲載情報の公開", body:[
    ...
    "利用者は、本サービスを通じた労働の実績が記録され、作物別および作業別の労働時間、労働の件数、再指名の状況、無断欠勤のない記録として、求職情報とともに求人者に公開されることに同意する。",
  ]},
  { id:"terms-8",  title:"第8条 当事者間の取引", body:[
    "求人者と求職者は、応募から評価にいたるやり取りに、本サービスの機能を利用することができます。チャットその他の連絡機能は、当事者の意思表示を加工せずに伝達する手段であり、運営者が内容の仲介、条件の調整、当事者の代理を行うことはありません。",
    "求人者と求職者は、報酬、労働条件、契約の内容を、当事者間で定める。",
    "求職者は、応募の時点で、当該求人に記載された内容に同意したものとする。",
  ]},
  { id:"terms-9",  title:"第9条 免責", body:[
    "当社は、求人者と求職者の間に生じた紛争について、当事者間の解決に委ねる。",
  ...
  { id:"terms-14", title:"第14条 お問い合わせ窓口", body:[
    "運営者は、福井滝人とする。屋号は、千歳とする。サービス名称は、chitose-bankとする。",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 11, color: "#B0B0B0", marginTop: 4 }}>千歳（chitose-bank） v1.0 · 制定日：2026年7月5日 · 最終改定日：2026年7月15日</p>
          </div>
