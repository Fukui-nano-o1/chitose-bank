...
// ＝第1条「表に無い取得は行いません」と実態の突き合わせ。v3.5への同意は0件のまま改訂so実質の版差は1段
// 2026-08-14(続2) v3.7：外部送信の明記（第5条＝地図タイル・郵便番号検索。フォントは同梱化so外部接続なし）＋
// 台帳2行追記（募集主の情報＝求人票でログイン利用者に表示／求人Q&A）。v3.6への同意も0件のままの続き改訂
export const TERMS_VERSION = "v2.3-2026-08";
...
// 2026-08-08たきと指示：準備・片付けを追加（並びは作業の流れ＝準備→播種→…→包装→片付け。収穫は最需要so先頭）。
