...
const HELP_CONTENT = {
  ...
  mails: {
    ...
    items: [
      ...
      { key:"mails-endNow",            label: "M33　仕事終了の時間です", body: "いつ：作業終了の予定時刻／誰に：農家・働き手の双方／内容：報酬は当日その場で現金でお渡し・お受け取りください。働き手＝「農家を評価する」、農家＝「完了して評価する」。※すでに評価・完了を記録していれば、その相手には送りません。作業後の繰り返しのお知らせはありません（M12・M13が担います）" },
