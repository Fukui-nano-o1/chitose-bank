...
const HELP_CONTENT = {
  ...
  mails: {
    ...
    items: [
      ...
      { key:"mails-noReplySeries",     label: "M34〜M39　応募が未回答のときのお知らせ", body: "いつ：応募から12・24・36・48・60・72時間が経過しても回答がない時／誰に：農家／内容：応募者が待っていることをお知らせします。応募者ページで「承認・見送り・保留・対応済み」のいずれかを選ぶと止まります" },
      ...
      { key:"mails-insuranceDone",     label: "（廃止）M09　保険の準備の報告", body: "農家の「保険を準備した」の報告は、メールではなくチャットに届くようになりました（2026-09-01）。報告は農家の発言としてチャットに残り、お知らせとプッシュでお伝えします。\nこの報告は農家の自己申告に基づきます（運営が保険の証書を確認するものではありません）" },
      ...
      { key:"mails-startNow",          label: "M32　仕事開始の時間です", body: "いつ：作業開始の時刻／誰に：農家・働き手の双方／内容：双方＝開始時刻は自動で記録されます（「今日の仕事を見る」）。農家は働き手が来たかを確認します（来なかった場合は作業後の完了の記録で残せます）" },
      { key:"mails-endNow",            label: "M33　本日の作業終了の時間です", body: "いつ：その日の作業終了の予定時刻（働く日ごと）／誰に：農家・働き手の双方／内容：報酬は当日その場で現金でお渡し・お受け取りください。次の作業日は「今日の仕事」から確認できます。※最終日はこのお知らせに代えてM42を送ります（同じ時刻に2通は送りません）" },
  ...
  faq: {
    ...
    items: [
      ...
      { key:"faq-interview",       label: "面接はできますか", body: "承認されると、チャットが使えるようになります。聞きたいことはチャットで直接やり取りできます（やり取りは記録として残るので、あとから見返せます）。集合場所や持ち物の確認も、このチャットでどうぞ。" },
