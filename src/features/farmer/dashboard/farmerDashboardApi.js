...
// 最終日の評価（2026-08-20に3問×3択＋タグへ再設計）。完了の記録・評価・お気に入り登録を
// 1つのRPC＝1トランザクションで行う。旧 submit_farmer_review はDBに残置（古いJSの互換用）。
export const submitFarmerFinalReviewRpc = (applicationId, r) =>
  supabase.rpc('submit_farmer_final_review', {
    p_application_id: applicationId,
    p_work_outcome: r.workOutcome,
    p_want_again_choice: r.wantAgainChoice,
    p_traits: r.traits || [],
