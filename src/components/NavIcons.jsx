...
const NAV_ICON_PATHS = {
  ...
  // 採用する：握手（旧🤝）＝左右の腕＋組んだ指の丸いこぶ3つ
  handshake: (
    <>
      <path d="M2.5 11.5h5.5l6.5 6.5a2.3 2.3 0 0 0 3.3-3.3l-3.6-3.6" />
      <path d="M29.5 11.5h-5.5l-3 3" />
      <path d="M14 20.5l1.3 1.3a2.3 2.3 0 0 0 3.3-3.3" />
      <path d="M17.6 24l.4.4a2.3 2.3 0 0 0 3.3-3.3" />
    </>
  ),
  // 保険の報告：盾＋チェック（旧🛡）
  shield: (
