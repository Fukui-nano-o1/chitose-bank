  ...
  return (
    <div>
      ...
      {selectedJob && (<>
        ...
        {/* 旧・「今日ページから来た時は戻るボックスを出さない」（2026-07-27）は撤廃（2026-08-22）：
        ...
        <div className="appear job-detail-body-mobile">
          {/* 写真の上の空きスペーサーは削除（2026-09-01たきと指示「画面上部の余白を埋めよう」）。
              2026-08-19に通報リンクを消した時の名残（当時は「余白を残して」）だったが、
              写真を画面の上いっぱいに出す今の形では余白そのものが要らない。
              スマホは main の上余白も消して写真を画面の天まで（appStyles・Airbnbと同じ） */}
