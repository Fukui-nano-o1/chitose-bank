...
const CONSIGNOR_IND_FIELDS = [
  ...
  { k:"ind_biz_addr_detail", l:"事業所の番地", hideWhenSame:true },
...
const CONSIGNOR_TERMS_FIELDS = [
  ...
  { k:"cmn_notify_email", l:"通知先メールアドレス" },
];
