...
export function MyReviewsOfWorker({ workerId }) {
  ...
  return (
    <div style={{ marginTop:14, background:"#F7FBF9", border:"1px solid #D8EFE3", borderRadius:12, padding:"12px 14px" }}>
      <p className="f-sans" style={{ fontSize:12, fontWeight:800, color:"#00A86B", margin:"0 0 2px" }}><NavIconInline name="clipboard" size={12} style={{ verticalAlign:"-1.5px" }} />あなたの評価</p>
