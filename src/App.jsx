...
const PRIVACY_SECTIONS = [
    ...
    { id:"privacy-3", title:"第3条 個人情報の取り扱い一覧・データ台帳", body:[
      ...
      rows:[
        ["メールアドレス","アカウント登録時","認証データベース（東京リージョン）。技術的な行制限により本人と運営者以外は読めません","他の利用者には**一切表示されません**。運営者の管理画面でも通常は伏せ字（例：t5***@…）で表示されます","アカウントの存続中。退会の申し出から30日以内に削除します。"],
        ["本人確認情報（氏名・ふりがな・住所・生年月日・電話番号）","登録直後の本人確認の入力時","専用テーブル。本人と運営者以外は読めません。変更があった事実は記録されますが、記録メールに値そのものは含めません","他の利用者には値は表示されず、**「本人確認済み」の表示と確認の年月だけ**が出ます","アカウントの存続中。退会の申し出から30日以内に削除します。"],
        ["プロフィールの選択項目（活動地域・移動手段・経験・作業の強さ・趣味・言語など）","本人が入力・選択した時","プロフィールテーブル","求人に応募した先の求人者、および求人を閲覧する求職者に**即時**表示されます","アカウントの存続中。本人はいつでも変更と削除ができます。退会の申し出から30日以内に削除します。"],
        ["自己紹介・質問への回答（自由記述）","本人が入力した時","まず**非公開の確認待ち**として保存","**運営者が内容を確認してから**（最大2日・確認され次第）応募先などに表示されます。確認するのは連絡先の記載・個人の特定・不適切な表現の有無だけです","アカウントの存続中。本人はいつでも変更と削除ができます。退会の申し出から30日以内に削除します。"],
        ["プロフィール写真・農園の紹介","本人が登録した時","画像ストレージ＋プロフィールテーブル","応募先・求人の閲覧者に表示されます","アカウントの存続中。退会の申し出から30日以内に削除します。"],
        ["集合場所の詳細（番地・目印）","求人者が求人を作成した時","求人テーブル。公開用の表示からは**除外**されています","**応募が承認された求職者にだけ**表示します。契約が成立した場合は、労働条件の確認記録の一部として保存されます。","求人の掲載が終わるまで。"],
        ["チャットの内容","送信した時","メッセージテーブル。技術的な行制限により**当事者以外は読めません**","当事者だけが読めます。運営者が内容を確認するのは、**苦情・通報・紛争への対応に必要な場合に限ります**","応募の終了から3年間保存し、削除します。"],
        ["応募・承認・作業の記録（応募日時・承認日時・開始と終了の確認・出欠・欠勤への異議）","それぞれの操作の時","応募テーブル","当事者の双方に表示されます。集計した実績（完了件数など）は将来、プロフィールに表示されます","アカウントの存続中。退会後は、個人を特定できない形にして保存します。"],
        ["労働条件の確認記録。双方が確認した時点の求人内容の写しです。写しには、募集主の氏名・住所・連絡先と、集合場所の詳しい住所が含まれます。","双方が「相違ありません」を押した時","応募テーブルに改変されない形で保存","契約の相手方に、契約の記録として表示されます。当事者の求めと紛争対応の際に使用します。運営者は印刷可能な形で保管します。","作業の完了から3年間保存し、削除します。"],
        ["評価（選択項目・公開コメント・非公開メモ）","作業完了後に本人が入力した時","評価テーブル","**公開されるのは肯定的な評価と公開コメントだけ**です。非公開メモは書いた本人しか見られません。双方の評価が揃うか3日たつまで相手には表示されません。全量は運営者がサービス改善と安全のために保存します","アカウントの存続中。退会後は、書いた人の情報を個人を特定できない形にして保存します。"],
        ["ページの閲覧履歴（どのページをいつ表示したか）","ページを表示した時","閲覧記録テーブル。**運営者だけ**が見られます","他の利用者には一切表示されません。使い道はサービスの改善（どの画面が分かりにくいかの分析）だけです","取得から30日で削除します。"],
        ["通報・画面の報告・緊急連絡","本人が送信した時","各記録テーブル","通報は運営者だけが確認し、**通報した人が誰かは相手に伝わりません**。緊急連絡は相手方と運営者に通知されます","対応の完了から3年間保存し、削除します。"],
      ],
    }},
