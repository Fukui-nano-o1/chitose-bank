...
const PRIVACY_SECTIONS = [
    ...
    { id:"privacy-3", title:"第3条 個人情報の取り扱い一覧・データ台帳", body:[
      ...
      rows:[
        ...
        ["本人確認情報（氏名・ふりがな・住所・生年月日・電話番号）","登録直後の本人確認の入力時","なりすましの防止と本人確認。不正利用の防止。雇用契約が成立した相手方への氏名の表示。","専用テーブル。本人と運営者以外は読めません。変更があった事実は記録されますが、記録メールに値そのものは含めません","他の利用者には値は表示されず、**「連絡先確認済み」の表示と登録の年月だけ**が出ます。雇用契約が成立した相手方には、雇用の法定手続きのため氏名が表示されます","アカウントの存続中。退会の申し出から30日以内に削除します。"],
...
const HELP_CONTENT = {
  ...
  info: {
    ...
    items: [
      { key:"info-personalData", label: "氏名・住所・生年月日・電話", body: "運営のみが保管します。画面には「✓ 連絡先確認済み」バッジだけが表示されます（お名前などの値は相手にも表示されません）。" },
