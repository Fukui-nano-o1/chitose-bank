...
const HELP_CONTENT = {
  ...
  mails: {
    ...
    items: [
      ...
      { key:"mails-startSoon15",       label: "M31　まもなく開始（15分前）", body: "いつ：作業開始の15分前／誰に：農家・働き手の双方／内容：遅れそうな時・中止延期の緊急連絡リンクつき" },
      { key:"mails-startNow",          label: "M32　作業開始の時間です", body: "いつ：作業開始の時刻／誰に：農家・働き手の双方／内容：働き手には「開始は自動で記録されます」、農家には「作業の開始を確認」への案内" },
      { key:"mails-endNow",            label: "M33　作業終了の時間です", body: "いつ：作業終了の予定時刻／誰に：農家・働き手の双方／内容：報酬は当日その場で現金でお渡し・お受け取りください。終了の確認と評価への案内つき" },
