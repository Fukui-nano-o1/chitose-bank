...
const PRIVACY_SECTIONS = [
    ...
    { id:"privacy-3", title:"第3条 個人情報の取り扱い一覧・データ台帳", body:[
      ...
      rows:[
        ...
        ["登録情報（氏名・住所・生年月日）","登録直後の登録情報の入力時","なりすましの防止。不正利用の防止。雇用契約が成立した相手方への氏名の表示。書類等による本人確認は行わず、ご本人の申告として扱います。","専用テーブル。本人と運営者以外は読めません。変更があった事実は記録されますが、記録メールに値そのものは含めません","他の利用者には値は表示されず、**「連絡先確認済み」の表示と登録の年月だけ**が出ます。雇用契約が成立した相手方には、雇用の法定手続きのため氏名が表示されます","アカウントの存続中。退会の申し出から30日以内に削除します。"],
